 ...
 */
Meeting::Meeting(const std::string &t_sponsor, const std::vector<std::string> &t_participator, const Date &t_startTime,
...
bool Meeting::isParticipator(const std::string &t_username) const
{
    ...
    it = find(m_participators.begin(), m_participators.end(), t_username);*/
